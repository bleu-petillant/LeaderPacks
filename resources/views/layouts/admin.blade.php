...
<script src="{{ asset ('admin/js/plugintiny.js') }}"></script>
...
@stack('modals')
    ...
    <script>
        ...
        $(function () {
            ...
            tinymce.init({
                selector : ".tiny",
                plugins : ["advlist autolink lists link charmap print preview anchor", "searchreplace visualblocks code fullscreen", " contextmenu paste", "wordcount", "charactercount"],
